...
const CreateJob = ({
  ...
  const createJobwithData = () => {
    const payload = {
      ...
      token: token == '' ? 0 : parseFloat(token),
      commission: driverCommision == '' ? 0 : parseFloat(driverCommision),
      inspection: inspection == '' ? 0 : parseFloat(inspection),
      mecrec: mecrec == '' ? 0 : parseFloat(mecrec),
      detention: detention == '' ? 0 : parseFloat(detention),
      driverIn: driverIn,
      driverOut: driverOut,
      vehicleIn: vehicleIn,
